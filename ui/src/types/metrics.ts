...
export const METRIC_DEFINITIONS: Record<MetricId, MetricDefinition> = {
  ...
  'ff-helix': {
    ...
    definition: 'Chou-Fasman propensity score using a 6-residue sliding window with threshold 1.0. This is a legacy metric — S4PRED Helix % is the primary helix prediction. Not comparable to S4PRED or experimental CD measurements.',
  ...
  'ff-helix-flag': {
    ...
    definition: 'Fibril-forming helix flag classifies peptides predicted to aggregate via an alpha-helical mechanism. Uses S4PRED helix segments with hydrophobic moment (μH) above the cohort threshold.',
    chartType: 'pie',
