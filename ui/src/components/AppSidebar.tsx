        ...
        <SheetContent side="left" className="w-64 p-0 pt-10 bg-[hsl(var(--background))]">
          <div className="flex items-center gap-2.5 px-5 pb-4 border-b border-[hsl(var(--border))]">
            ...
            <div>
              ...
              <span className="block text-[10px] text-[hsl(var(--faint))] leading-none mt-0.5">Peptide Visual Lab</span>
            </div>
          </div>
          <div className="pt-4">
      ...
      >
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            <span className="font-semibold text-small text-foreground">PVL</span>
            <span className="block text-[10px] text-[hsl(var(--faint))] leading-none mt-0.5 truncate">Peptide Visual Lab</span>
          </div>
        )}
      </div>
