...
from server import (
    uniprot_ping as ping_uniprot,
    parse_uniprot_query_endpoint as parse_uniprot_query_service,
    window_sequences_endpoint as window_sequences_service,
    execute_uniprot_query as execute_uniprot_query_service,
)
