"""
Batch processing script for offline peptide analysis.

This script is the entry point for batch/offline analysis workflows.
For the web API server, see server.py instead.
...
# calculate_biochemical_features is now imported from calculations.biochem
...
if __name__ == "__main__":
    ...
    for file in input_file_list:
        ...
        calculate_biochemical_features(cur_database, use_strict_validation=False)
